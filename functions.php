...
$url = "https://api.telegram.org/bot7065725244:AAHt3fC3_q6rfIMqRG5jM02xQB_I-MEVAXY/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=".$message."&parse_mode=HTML";
file_get_contents($url);      
}
